...
Minimal schema for Fintel report response with keys, types, and descriptions
...
**sub_type** | [**FintelReportSubType**](FintelReportSubType.md) |  | 
...
json = "{}"
# create an instance of FintelResponse from a JSON string
fintel_response_instance = FintelResponse.from_json(json)
# print the JSON string representation of the object
print(FintelResponse.to_json())

# convert the object into a dict
fintel_response_dict = fintel_response_instance.to_dict()
# create an instance of FintelResponse from a dict
fintel_response_from_dict = FintelResponse.from_dict(fintel_response_dict)
```
