...
class ActorObject(BaseModel):
    ...
    forum: Optional[ForumObject] = None
    __properties: ClassVar[List[str]] = ["id", "handles", "forum"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "forum": ForumObject.from_dict(obj["forum"]) if obj.get("forum") is not None else None
        })
        return _obj
