...
class Actor(BaseModel):
    ...
    im_server: Optional[ImServer] = None
    report: Optional[Report] = None
    __properties: ClassVar[List[str]] = ["id", "activity", "handles", "forum", "im_server", "report"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of im_server
        if self.im_server:
            _dict['im_server'] = self.im_server.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "im_server": ImServer.from_dict(obj["im_server"]) if obj.get("im_server") is not None else None,
