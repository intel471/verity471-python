...
class StreamingAlertsResponse(BaseModel):
    """
    StreamingAlertsResponse
    """ # noqa: E501
    count: StrictInt
    cursor_next: Optional[StrictStr] = None
    alerts: Optional[List[StreamingWatcherAlert]] = None
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "alerts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "alerts": [StreamingWatcherAlert.from_dict(_item) for _item in obj["alerts"]] if obj.get("alerts") is not None else None
        })
        return _obj
