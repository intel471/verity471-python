...
class VulnerabilitiesReportsResponseStream(BaseModel):
    """
    VulnerabilitiesReportsResponseStream
    """ # noqa: E501
    count: StrictInt = Field(description="Number of total Vulnerabilities reports matching the query")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from")
    reports: Optional[List[VulnerabilitiesReportDetailsResponseStream]] = Field(default=None, description="List of Vulnerabilities reports in the current batch")
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "reports"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reports": [VulnerabilitiesReportDetailsResponseStream.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None
        })
        return _obj
