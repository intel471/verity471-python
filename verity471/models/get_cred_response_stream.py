...
class GetCredResponseStream(BaseModel):
    """
    GetCredResponseStream
    """ # noqa: E501
    count: StrictInt = Field(description="Number of total credentials")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from")
    credentials: Optional[List[GetCredResponse]] = Field(default=None, description="The credentials")
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "credentials"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentials": [GetCredResponse.from_dict(_item) for _item in obj["credentials"]] if obj.get("credentials") is not None else None
        })
        return _obj
