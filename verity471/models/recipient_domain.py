...
class RecipientDomain(BaseModel):
    ...
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Count of recipient domains.")
    domain: Optional[StrictStr] = Field(default=None, description="Recipient domain.")
    __properties: ClassVar[List[str]] = ["count", "domain"]
