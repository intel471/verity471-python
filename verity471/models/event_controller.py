...
class EventController(BaseModel):
    ...
    """ # noqa: E501
    ipv4: Optional[Ipv4] = Field(default=None, description="The `ipv4` of a controller")
    url: Optional[StrictStr] = Field(default=None, description="The `url` of a controller.")
    __properties: ClassVar[List[str]] = ["ipv4", "url"]
