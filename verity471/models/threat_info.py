...
class ThreatInfo(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier of the threat.")
    type: StrictStr = Field(description="Type of the threat.")
    family: StrictStr = Field(description="Family classification of the threat.")
    __properties: ClassVar[List[str]] = ["id", "type", "family"]
