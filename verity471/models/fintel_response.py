...
class FintelResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["attachments", "body", "classification", "creation_ts", "derived_entities", "entities", "id", "information_ts", "is_sensitive_source", "is_truncated", "last_updated_ts", "links", "locations", "related_reports", "released_ts", "sources", "sub_type", "title", "type", "victims"]
