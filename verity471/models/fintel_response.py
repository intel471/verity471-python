...
class FintelResponse(BaseModel):
    ...
    links: Links
    __properties: ClassVar[List[str]] = ["id", "type", "sub_type", "title", "information_ts", "creation_ts", "released_ts", "entities", "locations", "last_updated_ts", "classification", "body", "sources", "victims", "is_sensitive_source", "attachments", "related_reports", "derived_entities", "is_truncated", "links"]
