...
class IspData(BaseModel):
    """
    Internet Service Provider information for the IP address
    """ # noqa: E501
    autonomous_system: Optional[StrictStr] = Field(default=None, description="Autonomous System Number (ASN) information")
    isp: Optional[StrictStr] = Field(default=None, description="Name of the Internet Service Provider")
    network: Optional[StrictStr] = Field(default=None, description="Network range information for the IP address")
    organization: Optional[StrictStr] = Field(default=None, description="Organization name associated with the IP address")
    __properties: ClassVar[List[str]] = ["autonomous_system", "isp", "network", "organization"]
