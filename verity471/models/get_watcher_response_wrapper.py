...
class GetWatcherResponseWrapper(BaseModel):
    """
    GetWatcherResponseWrapper
    """ # noqa: E501
    count: StrictInt
    watchers: Optional[List[GetWatcherResponse]] = None
    __properties: ClassVar[List[str]] = ["count", "watchers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "watchers": [GetWatcherResponse.from_dict(_item) for _item in obj["watchers"]] if obj.get("watchers") is not None else None
        })
        return _obj
