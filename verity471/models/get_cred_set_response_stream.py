...
class GetCredSetResponseStream(BaseModel):
    """
    GetCredSetResponseStream
    """ # noqa: E501
    count: StrictInt = Field(description="Number of total credential sets")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from")
    credential_sets: Optional[List[GetCredSetResponse]] = Field(default=None, description="Credential sets")
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "credential_sets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credential_sets": [GetCredSetResponse.from_dict(_item) for _item in obj["credential_sets"]] if obj.get("credential_sets") is not None else None
        })
        return _obj
