...
class Entity(BaseModel):
    ...
    Entity
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier of the entity")
    type: EntityType
    value: StrictStr = Field(description="The value of the entity")
    activity: Activity
    report: Optional[ReportEntities] = None
    actor: Optional[ActorObject] = None
    __properties: ClassVar[List[str]] = ["id", "type", "value", "activity", "report", "actor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "report": ReportEntities.from_dict(obj["report"]) if obj.get("report") is not None else None,
            "actor": ActorObject.from_dict(obj["actor"]) if obj.get("actor") is not None else None
        })
        return _obj
