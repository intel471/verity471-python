...
class GeoIpObservables(BaseModel):
    """
    ...
    subdivision: Optional[List[StrictStr]] = None
    isp: Optional[Isp] = None
    __properties: ClassVar[List[str]] = ["country", "country_code", "city", "subdivision", "isp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isp": Isp.from_dict(obj["isp"]) if obj.get("isp") is not None else None
        })
        return _obj
