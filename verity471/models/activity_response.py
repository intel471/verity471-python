...
class ActivityResponse(BaseModel):
    ...
    """ # noqa: E501
    first_seen_ts: StrictStr = Field(description="Start of the credential activity range.")
    last_seen_ts: StrictStr = Field(description="End of the credential activity range.")
    __properties: ClassVar[List[str]] = ["first_seen_ts", "last_seen_ts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "first_seen_ts": obj.get("first_seen_ts"),
            "last_seen_ts": obj.get("last_seen_ts")
        })
        return _obj
