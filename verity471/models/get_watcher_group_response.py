...
class GetWatcherGroupResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_by", "creation_ts", "description", "id", "is_editable", "is_global", "is_muted", "is_subscribed", "last_updated_ts", "name", "notification_settings", "organisation_id", "owner_user_id", "sharing_settings", "updated_by", "watcher_ids"]
