...
class GetCredOccurrenceResponse(BaseModel):
    """
    GetCredOccurrenceResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Unique credential occurrence identifier.")
    data: CredentialOccurrenceDataResponse
    classification: Optional[ClassificationResponse] = None
    last_updated_ts: StrictStr = Field(description="Credential occurrence last modification date.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "data": CredentialOccurrenceDataResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
