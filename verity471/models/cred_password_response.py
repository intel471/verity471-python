...
class CredPasswordResponse(BaseModel):
    """
    Credential password details.
    """ # noqa: E501
    complexity: Optional[CredPasswordComplexityResponse] = None
    strength: Optional[StrictStr] = Field(default=None, description="Password strength. Allowed values: excellent, strong, medium, weak, poor, not_provided.")
    id: Optional[StrictStr] = Field(default=None, description="ID of the password.")
    password_plain: Optional[StrictStr] = Field(default=None, description="Password plain text.")
    __properties: ClassVar[List[str]] = ["complexity", "strength", "id", "password_plain"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "complexity": CredPasswordComplexityResponse.from_dict(obj["complexity"]) if obj.get("complexity") is not None else None,
