...
class ThreadResponse1(BaseModel):
    """
    ThreadResponse1
    """ # noqa: E501
    activity: Activity
    id: StrictStr = Field(description="Thread unique id")
    links: Optional[SourcesLinks] = None
    post_count: StrictInt = Field(description="Number of posts within a thread")
    topic: Optional[StrictStr] = Field(default=None, description="Topic name")
    topic_original: Optional[StrictStr] = Field(default=None, description="Original topic name")
    translation_status: Optional[TranslationStatus] = None
    __properties: ClassVar[List[str]] = ["activity", "id", "links", "post_count", "topic", "topic_original", "translation_status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "topic": obj.get("topic"),
            "topic_original": obj.get("topic_original"),
