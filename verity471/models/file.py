...
class File(BaseModel):
    ...
    File information
    """ # noqa: E501
    md5: Optional[StrictStr] = Field(default=None, description="MD5 hash of the file")
    sha1: Optional[StrictStr] = Field(default=None, description="SHA-1 hash of the file")
    sha256: Optional[StrictStr] = Field(default=None, description="SHA-256 hash of the file")
    size: Optional[StrictInt] = Field(default=None, description="Size of the file in bytes")
    ssdeep: Optional[StrictStr] = Field(default=None, description="SSDeep hash of the file")
    type: Optional[StrictStr] = Field(default=None, description="Type of the file")
    __properties: ClassVar[List[str]] = ["md5", "sha1", "sha256", "size", "ssdeep", "type"]
