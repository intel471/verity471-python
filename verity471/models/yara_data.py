...
class YaraData(BaseModel):
    """
    Yara data
    """ # noqa: E501
    signature: Optional[StrictStr] = Field(default=None, description="Yara signature")
    title: Optional[StrictStr] = Field(default=None, description="Title of the Yara rule")
    __properties: ClassVar[List[str]] = ["signature", "title"]
