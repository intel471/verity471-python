...
class CredSetAccessedDomainDataResponse(BaseModel):
    """
    Credential set accessed Domain with related objects.
    """ # noqa: E501
    accessed_domain: StrictStr = Field(description="Accessed domain.")
    credential_set: Optional[CredCredentialSetResponse] = None
    __properties: ClassVar[List[str]] = ["accessed_domain", "credential_set"]
