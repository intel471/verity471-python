...
class InfoReportsResponseStream(BaseModel):
    """
    InfoReportsResponseStream
    """ # noqa: E501
    count: StrictInt = Field(description="Number of total Info reports matching the query")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from")
    reports: Optional[List[InfoReportResponse]] = Field(default=None, description="List of Info reports in the current batch")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reports": [InfoReportResponse.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None
        })
        return _obj
