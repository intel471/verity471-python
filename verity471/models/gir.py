...
class GIR(BaseModel):
    """
    General Intelligence Requirement information
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the General Intelligence Requirement")
    path: StrictStr = Field(description="Path of the General Intelligence Requirement")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GIR from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GIR from a dict"""
        if obj is None:
            return None
