...
class ServerStream(BaseModel):
    """
    Chat server entity
    """ # noqa: E501
    id: StrictStr = Field(description="Chat server id")
    links: Optional[SourcesLinks] = None
    name: StrictStr = Field(description="Chat server name")
    type: StrictStr = Field(description="Chat server type")
    __properties: ClassVar[List[str]] = ["id", "links", "name", "type"]
