...
class EventsStream(BaseModel):
    """
    Stream of events
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Total count of events matching the query")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Cursor for retrieving the next page of results")
    events: Optional[List[IntegrationsEvent]] = Field(default=None, description="List of events")
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": [IntegrationsEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
