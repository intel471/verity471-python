...
class ForumsPostsStreamingPage(BaseModel):
    """
    ...
    posts: Optional[List[PostDetails1]] = Field(default=None, description="A page of matched post entities")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "posts": [PostDetails1.from_dict(_item) for _item in obj["posts"]] if obj.get("posts") is not None else None
        })
        return _obj
