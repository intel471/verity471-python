...
class DataLeakSitePostsStreamingPage(BaseModel):
    """
    DataLeakSitePostsStreamingPage
    """ # noqa: E501
    count: StrictInt = Field(description="Total count of matched post entities")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from")
    posts: Optional[List[DataLeakSitePostItem]] = Field(default=None, description="A page of matched post entities with nested thread and website")
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "posts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "posts": [DataLeakSitePostItem.from_dict(_item) for _item in obj["posts"]] if obj.get("posts") is not None else None
        })
        return _obj
