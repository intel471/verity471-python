...
class ForumsResponse1(BaseModel):
    """
    ForumsResponse1
    """ # noqa: E501
    activity: Activity
    description: Optional[StrictStr] = Field(default=None, description="Description of forum")
    id: StrictStr = Field(description="Forum unique id")
    links: Optional[SourcesLinks] = None
    title: StrictStr = Field(description="Forum title")
    __properties: ClassVar[List[str]] = ["activity", "description", "id", "links", "title"]
