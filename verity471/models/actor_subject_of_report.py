...
class ActorSubjectOfReport(BaseModel):
    """
    ActorSubjectOfReport
    """ # noqa: E501
    handle: StrictStr = Field(description="Handle or identifier of the actor")
    aliases: Optional[List[StrictStr]] = Field(default=None, description="List of alternative names for the actor")
    __properties: ClassVar[List[str]] = ["handle", "aliases"]
