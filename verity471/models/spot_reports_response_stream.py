...
class SpotReportsResponseStream(BaseModel):
    """
    SpotReportsResponseStream
    """ # noqa: E501
    count: StrictInt = Field(description="Number of total Spot reports matching the query")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from")
    reports: Optional[List[SpotReportResponse]] = Field(default=None, description="List of Spot reports in the current batch")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reports": [SpotReportResponse.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None
        })
        return _obj
