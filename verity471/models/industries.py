...
class Industries(BaseModel):
    ...
    Industries
    """ # noqa: E501
    industry: StrictStr = Field(description="Name of the industry")
    sector: StrictStr = Field(description="Sector of the industry")
    __properties: ClassVar[List[str]] = ["industry", "sector"]
