...
class GetCredSetResponse(BaseModel):
    """
    GetCredSetResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Unique credential set identifier.")
    data: CredSetDataResponse
    statistics: Optional[CredSetStatisticsResponse] = None
    classification: Optional[ClassificationResponse] = None
    last_updated_ts: StrictStr = Field(description="Credential set last modification date.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "data": CredSetDataResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "statistics": CredSetStatisticsResponse.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
