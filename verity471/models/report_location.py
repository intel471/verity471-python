...
class ReportLocation(BaseModel):
    ...
    """ # noqa: E501
    country: Optional[StrictStr] = Field(default=None, description="Country name related to the report")
    iso: Optional[StrictStr] = Field(default=None, description="Country iso code related to the report")
    link: Optional[StrictStr] = Field(default=None, description="Linkage type or relation to the location")
    region: StrictStr = Field(description="Region name related to the report")
    __properties: ClassVar[List[str]] = ["country", "iso", "link", "region"]
