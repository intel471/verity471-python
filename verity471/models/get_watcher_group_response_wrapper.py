...
class GetWatcherGroupResponseWrapper(BaseModel):
    """
    GetWatcherGroupResponseWrapper
    """ # noqa: E501
    count: StrictInt
    watchers_groups: Optional[List[GetWatcherGroupResponse]] = None
    __properties: ClassVar[List[str]] = ["count", "watchers_groups"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in watchers_groups (list)
        _items = []
        if self.watchers_groups:
            for _item_watchers_groups in self.watchers_groups:
                if _item_watchers_groups:
                    _items.append(_item_watchers_groups.to_dict())
            _dict['watchers_groups'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "watchers_groups": [GetWatcherGroupResponse.from_dict(_item) for _item in obj["watchers_groups"]] if obj.get("watchers_groups") is not None else None
        })
        return _obj
