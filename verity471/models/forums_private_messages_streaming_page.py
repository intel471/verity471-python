...
class ForumsPrivateMessagesStreamingPage(BaseModel):
    """
    ForumsPrivateMessagesStreamingPage
    """ # noqa: E501
    count: StrictInt = Field(description="Total count of matched private message entities")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from")
    private_messages: Optional[List[PrivateMessageDetails1]] = Field(default=None, description="A page of matched private message entities")
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "private_messages"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in private_messages (list)
        _items = []
        if self.private_messages:
            for _item_private_messages in self.private_messages:
                if _item_private_messages:
                    _items.append(_item_private_messages.to_dict())
            _dict['private_messages'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "private_messages": [PrivateMessageDetails1.from_dict(_item) for _item in obj["private_messages"]] if obj.get("private_messages") is not None else None
        })
        return _obj
