...
class Ipv4(BaseModel):
    ...
    """ # noqa: E501
    geo_ip: Optional[GeoIp] = Field(default=None, description="Geographical information associated with the IP address")
    ip_address: Optional[StrictStr] = Field(default=None, description="IPv4 address in dotted decimal notation")
    __properties: ClassVar[List[str]] = ["geo_ip", "ip_address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "geo_ip": GeoIp.from_dict(obj["geo_ip"]) if obj.get("geo_ip") is not None else None,
