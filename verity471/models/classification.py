...
class Classification(BaseModel):
    ...
    """ # noqa: E501
    girs: Optional[List[GIR]] = Field(default=None, description="List of General Intelligence Requirements (GIRs) associated with the classification")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "girs": [GIR.from_dict(_item) for _item in obj["girs"]] if obj.get("girs") is not None else None
        })
        return _obj
