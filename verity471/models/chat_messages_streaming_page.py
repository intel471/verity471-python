...
class ChatMessagesStreamingPage(BaseModel):
    """
    ChatMessagesStreamingPage
    """ # noqa: E501
    count: StrictInt = Field(description="Total count of matched message entities")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from")
    messages: Optional[List[ChatRoomMessageStream]] = Field(default=None, description="A page of matched message entities")
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "messages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [ChatRoomMessageStream.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
