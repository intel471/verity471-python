...
class DataLeakSitePostThread(BaseModel):
    """
    ...
    links: SourcesLinks
    title: StrictStr
    __properties: ClassVar[List[str]] = ["id", "links", "title"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataLeakSitePostThread from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataLeakSitePostThread from a dict"""
        if obj is None:
            return None
