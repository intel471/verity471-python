...
class GirTree(BaseModel):
    """
    GirTree
    """ # noqa: E501
    children: Optional[List[GirTree]] = None
    deprecated: Optional[StrictBool] = None
    description: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["children", "deprecated", "description", "id", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "children": [GirTree.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None,
...
GirTree.model_rebuild(raise_errors=False)
