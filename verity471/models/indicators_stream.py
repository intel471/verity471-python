...
class IndicatorsStream(BaseModel):
    """
    Stream of indicators
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Total count of indicators matching the query")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Cursor for retrieving the next page of results")
    indicators: Optional[List[IntegrationsIndicator]] = Field(default=None, description="List of indicators")
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "indicators"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "indicators": [IntegrationsIndicator.from_dict(_item) for _item in obj["indicators"]] if obj.get("indicators") is not None else None
        })
        return _obj
