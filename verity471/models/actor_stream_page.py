...
class ActorStreamPage(BaseModel):
    """
    ActorStreamPage
    """ # noqa: E501
    count: StrictInt = Field(description="Total count of matched actors")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from")
    actors: Optional[List[Actor]] = Field(default=None, description="A page of matched actors")
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "actors"]
