...
class ClassificationResponse(BaseModel):
    ...
    """ # noqa: E501
    girs: Optional[List[GirsResponse]] = Field(default=None, description="General Intelligence Requirements that match the credential.")
    __properties: ClassVar[List[str]] = ["girs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "girs": [GirsResponse.from_dict(_item) for _item in obj["girs"]] if obj.get("girs") is not None else None
        })
        return _obj
