...
class KillChainPhase(BaseModel):
    ...
    """ # noqa: E501
    kill_chain_name: Optional[StrictStr] = Field(default=None, description="Name of the kill chain framework")
    phase_name: Optional[StrictStr] = Field(default=None, description="Name of the phase within the kill chain")
    __properties: ClassVar[List[str]] = ["kill_chain_name", "phase_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kill_chain_name": obj.get("kill_chain_name"),
