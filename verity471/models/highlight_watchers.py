...
class HighlightWatchers(BaseModel):
    """
    HighlightWatchers
    """ # noqa: E501
    field_name: StrictStr
    snippets: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["field_name", "snippets"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HighlightWatchers from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HighlightWatchers from a dict"""
        if obj is None:
            return None
