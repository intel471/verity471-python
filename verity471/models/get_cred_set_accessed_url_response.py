...
class GetCredSetAccessedUrlResponse(BaseModel):
    """
    GetCredSetAccessedUrlResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Unique credential set accessed url identifier.")
    data: CredSetAccessedUrlDataResponse
    classification: Optional[ClassificationResponse] = None
    last_updated_ts: StrictStr = Field(description="Credential set accessed url last modification date.")
    activity: ActivityResponse
    __properties: ClassVar[List[str]] = ["id", "data", "classification", "last_updated_ts", "activity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "data": CredSetAccessedUrlDataResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
