...
class AuthorActor1(BaseModel):
    """
    AuthorActor1
    """ # noqa: E501
    historical_usernames: Optional[List[StrictStr]] = Field(default=None, description="Author previous usernames")
    id: StrictStr = Field(description="Unique id of actor")
    user_name: StrictStr = Field(description="Username")
    user_name_id: StrictStr
    __properties: ClassVar[List[str]] = ["historical_usernames", "id", "user_name", "user_name_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "historical_usernames": obj.get("historical_usernames"),
            "id": obj.get("id"),
            "user_name": obj.get("user_name"),
            "user_name_id": obj.get("user_name_id")
        })
        return _obj
