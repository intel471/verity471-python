...
class ObservableStreamPage(BaseModel):
    """
    ObservableStreamPage
    """ # noqa: E501
    count: StrictInt = Field(description="Total count of matched observables")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from")
    observables: Optional[List[Observable]] = Field(default=None, description="A page of matched observables")
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "observables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "observables": [Observable.from_dict(_item) for _item in obj["observables"]] if obj.get("observables") is not None else None
        })
        return _obj
