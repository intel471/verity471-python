...
class GetCredSetAccessedDomainResponse(BaseModel):
    """
    GetCredSetAccessedDomainResponse
    """ # noqa: E501
    activity: ActivityResponse
    classification: Optional[ClassificationResponse] = None
    data: CredSetAccessedDomainDataResponse
    id: StrictStr = Field(description="Unique credential set accessed domain identifier.")
    last_updated_ts: StrictStr = Field(description="Credential set accessed domain last modification date.")
    __properties: ClassVar[List[str]] = ["activity", "classification", "data", "id", "last_updated_ts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CredSetAccessedDomainDataResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "id": obj.get("id"),
