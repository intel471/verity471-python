...
class ChatMessageStream(BaseModel):
    ...
    Message entity
    """ # noqa: E501
    attachments: Optional[List[AttachmentData]] = Field(default=None, description="Message attachments and images")
    author: Optional[AuthorActor1] = None
    creation_ts: StrictStr = Field(description="Timestamp when the message was published first time")
    html: StrictStr = Field(description="Message text in html format")
    id: StrictStr = Field(description="Unique id of message")
    links: Optional[SourcesLinks] = None
    text: StrictStr = Field(description="Message text")
    __properties: ClassVar[List[str]] = ["attachments", "author", "creation_ts", "html", "id", "links", "text"]
