...
class ReportAttachment(BaseModel):
    ...
    file_name: StrictStr = Field(description="Name of the attachment file")
    file_size: StrictInt = Field(description="Size of the attachment file in bytes")
    malicious: StrictBool = Field(description="Indicates if the attachment is malicious")
    mime_type: StrictStr = Field(description="MIME type of the attachment")
    url: StrictStr = Field(description="URL to download the attachment")
    __properties: ClassVar[List[str]] = ["description", "file_name", "file_size", "malicious", "mime_type", "url"]
