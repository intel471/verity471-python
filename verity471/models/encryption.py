...
class Encryption(BaseModel):
    ...
    """ # noqa: E501
    algorithm: Optional[StrictStr] = Field(default=None, description="Type of `algorithm` used in the encryption.")
    context: Optional[StrictStr] = Field(default=None, description="The `context' of the event.")
    key: Optional[StrictStr] = Field(default=None, description="The encryption `key`.")
    __properties: ClassVar[List[str]] = ["algorithm", "context", "key"]
