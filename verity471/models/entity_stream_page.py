...
class EntityStreamPage(BaseModel):
    """
    EntityStreamPage
    """ # noqa: E501
    count: StrictInt = Field(description="Total count of matched entities")
    cursor_next: Optional[StrictStr] = Field(default=None, description="Stream position identifier to continue scrolling from")
    entities: Optional[List[Entity]] = Field(default=None, description="A page of matched entities")
    __properties: ClassVar[List[str]] = ["count", "cursor_next", "entities"]
