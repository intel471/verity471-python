...
class CountryProfileResponse(BaseModel):
    ...
    threat_rating: Optional[ThreatRating] = None
    security_assessment: Optional[SecurityAssessment] = None
    information_ts: StrictStr
    is_country_of_interest: StrictBool
    __properties: ClassVar[List[str]] = ["id", "country", "country_iso_code", "threat_rating", "security_assessment", "information_ts", "is_country_of_interest"]
