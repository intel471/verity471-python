...
class BotSettings(BaseModel):
    ...
    """ # noqa: E501
    encryption: Optional[List[Encryption]] = Field(default=None, description="Encryption information.")
    exit_country: Optional[StrictStr] = Field(default=None, description="Country where the malware bot is running.")
    settings: Optional[List[Dict[str, StrictStr]]] = Field(default=None, description="Settings information.")
    __properties: ClassVar[List[str]] = ["encryption", "exit_country", "settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exit_country": obj.get("exit_country"),
