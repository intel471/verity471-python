...
class Threat(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[ThreatData] = Field(default=None, description="Detailed data about the threat")
    type: Optional[StrictStr] = Field(default=None, description="Type of the threat")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['malware', 'bulletproof_hosting']):
            raise ValueError("must be one of enum values ('malware', 'bulletproof_hosting')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ThreatData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type")
        })
        return _obj
