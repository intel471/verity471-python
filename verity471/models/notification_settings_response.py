...
class NotificationSettingsResponse(BaseModel):
    ...
    """ # noqa: E501
    notification_preference_type: NotificationPreferenceType
    notification_channel: StrictStr
    notify_at_utc_hour: Optional[StrictInt] = None
    created: datetime
    __properties: ClassVar[List[str]] = ["notification_preference_type", "notification_channel", "notify_at_utc_hour", "created"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notification_preference_type": obj.get("notification_preference_type"),
            "notification_channel": obj.get("notification_channel"),
            "notify_at_utc_hour": obj.get("notify_at_utc_hour"),
