...
class Redirect(BaseModel):
    ...
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="Address of the redirect.")
    host: Optional[StrictStr] = Field(default=None, description="Host of the redirect.")
    __properties: ClassVar[List[str]] = ["address", "host"]
